...
namespace Tests2AnotherTry.Tests
{
    ...
    public class FileTests
    {
        ...
        {
            var file = new Tests2AnotherTry2.Tests2AnotherTry2.File("test.txt", "abc");
        ...
        {
            var file = new Tests2AnotherTry2.Tests2AnotherTry2.File("test.txt", "123456");
        ...
        {
            var file = new Tests2AnotherTry2.Tests2AnotherTry2.File("empty.txt", "");
        ...
        {
            var file = new Tests2AnotherTry2.Tests2AnotherTry2.File("myfile.doc", "content");
        ...
        public void GetSize_ShouldTruncateDecimal_WhenContentLengthIsOdd()
        {
            ...
            var file = new Tests2AnotherTry2.Tests2AnotherTry2.File("odd.txt", "12345");
        ...
        public void Constructor_ShouldSetExtensionCorrectly()
        {
            ...
            var file = new Tests2AnotherTry2.Tests2AnotherTry2.File("document.pdf", "hello world");
